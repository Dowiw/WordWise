...
void WordDatabase::initializeDefaultWords() {
	...
	vector<Word> defaultWords = {
		...
		{"Auto", "car", WordType::NOUN, 1, 0, 0},
		{"Buch", "book", WordType::NOUN, 1, 0, 0},
		{"Schule", "school", WordType::NOUN, 1, 0, 0},
		{"laufen", "to run", WordType::VERB, 1, 0, 0},
		{"springen", "to jump", WordType::VERB, 1, 0, 0},
		{"denken", "to think", WordType::VERB, 1, 0, 0},
		{"schnell", "fast", WordType::ADJECTIVE, 1, 0, 0},
		{"langsam", "slow", WordType::ADJECTIVE, 1, 0, 0},
		{"glücklich", "happy", WordType::ADJECTIVE, 1, 0, 0},
		{"traurig", "sad", WordType::ADJECTIVE, 1, 0, 0},
		{"Flugzeug", "airplane", WordType::NOUN, 1, 0, 0},
		{"Zug", "train", WordType::NOUN, 1, 0, 0},
		{"Fahrrad", "bicycle", WordType::NOUN, 1, 0, 0},
		{"kochen", "to cook", WordType::VERB, 1, 0, 0},
		{"schwimmen", "to swim", WordType::VERB, 1, 0, 0},
		{"singen", "to sing", WordType::VERB, 1, 0, 0},
		{"schön", "beautiful", WordType::ADJECTIVE, 1, 0, 0},
		{"hässlich", "ugly", WordType::ADJECTIVE, 1, 0, 0},
		{"groß", "big", WordType::ADJECTIVE, 1, 0, 0},
		{"klein", "small", WordType::ADJECTIVE, 1, 0, 0},
		{"Hund", "dog", WordType::NOUN, 1, 0, 0},
		{"Katze", "cat", WordType::NOUN, 1, 0, 0},
		{"Vogel", "bird", WordType::NOUN, 1, 0, 0},
		{"laufen", "to walk", WordType::VERB, 1, 0, 0},
		{"springen", "to jump", WordType::VERB, 1, 0, 0},
		{"tanzen", "to dance", WordType::VERB, 1, 0, 0},
		{"rot", "red", WordType::ADJECTIVE, 1, 0, 0},
		{"blau", "blue", WordType::ADJECTIVE, 1, 0, 0},
		{"grün", "green", WordType::ADJECTIVE, 1, 0, 0},
		{"gelb", "yellow", WordType::ADJECTIVE, 1, 0, 0},
		{"Haus", "house", WordType::NOUN, 1, 0, 0},
		{"Wohnung", "apartment", WordType::NOUN, 1, 0, 0},
		{"Zimmer", "room", WordType::NOUN, 1, 0, 0},
		{"Küche", "kitchen", WordType::NOUN, 1, 0, 0},
